...
if("FALSE" STREQUAL "TRUE")
  set(perception_msgs_SOURCE_PREFIX /home/team4/catkin_ws/src/cse481wi19/perception_msgs)
  set(perception_msgs_DEVEL_PREFIX /home/team4/catkin_ws/src/devel)
  ...
  set(perception_msgs_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'perception_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'team4 <team4@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'perception_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'team4 <team4@todo.todo>' to fix it.")
    endif()
...
set(perception_msgs_EXPORTED_TARGETS "perception_msgs_generate_messages_cpp;perception_msgs_generate_messages_lisp;perception_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${perception_msgs_dep}_FOUND)
      find_package(${perception_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${perception_msgs_dep} REQUIRED ${depend_list})
  endif()
