...
class GripperTeleop(object):
    ...
    def start(self):
        ...
        gripper_im = gripper_interactive_marker(ps, 0.1)
...
class PickPlaceTeleop(object):
    ...
    def _update_grippers(self):
        ...
        pregrasp_im = gripper_interactive_marker(pregrasp_pose, 0.1)
        ...
        grasp_im = gripper_interactive_marker(grasp_pose, 0.1)
        grasp_im.name = 'grasp'
        ...
        lift_im = gripper_interactive_marker(lift_pose, 0.1)
        lift_im.name = 'lift'
